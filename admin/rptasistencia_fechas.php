            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      Inicio: <?php echo $f1 ?> - Fin: <?php echo $f2 ?> 
                      ...
                      <table id="example1" class="table table-bordered"> </br>
                        ...
                        <tbody>
                          <?php
                            ...
                            $sql = "SELECT *, employees.employee_id AS empid, attendance.id AS attid FROM attendance LEFT JOIN employees ON employees.id=attendance.employee_id WHERE date BETWEEN '$f1' AND '$f2' ORDER BY attendance.date DESC, attendance.time_in DESC ";
