        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="number" min="11111111" max="99999999" class="form-control" id="address" name="address" required>
                  	</div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_address" class="col-sm-3 control-label">DNI</label>
